        ...
        <div class="row">
            <div class="col">
                <div class="input-group mb-3">
                    ...
                    <select name="curso_id" class="form-select form-control">
                        @foreach ($cursos as $item)
                            <option
                                value="{{ $item->id }}"
                                @if($item->id == $disciplina->curso_id) selected="true" @endif
                            >
                                {{ $item->nome }}
                            </option>
                        @endforeach
            ...
            <div class="col">
                <div class="form-floating mb-3">
                    <input
                        ...
                        value="{{ $disciplina->aulas }}"
                    />
                    <label for="aulas">Aulas Semanais</label>
                </div>
            </div>
        </div>
