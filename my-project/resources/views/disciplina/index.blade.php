...
@section('conteudo')
    ...
    <table class="table align-middle caption-top table-striped">
        <thead>
            ...
            <th class="d-none d-md-table-cell text-secondary">AULAS</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a nohref style="cursor:pointer"
                           onclick="showRemoveModal('{{ $item->id }}', '{{ $item->nome }} - {{ $item->curso->nome }}')"
                        ...
                        <form action="{{ route('disciplina.destroy', $item->id) }}" method="POST" id="form_{{$item->id}}">
                            @csrf
                            @method('delete')
                        </form>
                    </td>
