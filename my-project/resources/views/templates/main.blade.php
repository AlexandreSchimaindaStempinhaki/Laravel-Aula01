            ...
            <div class="collapse navbar-collapse" id="itens">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item me-2">
                        <a href="{{ url('/aluno') }}" class="nav-link">
                    ...
                    <!-- Cursos -->
                    <li class="nav-item me-2">
                        <a href="{{ url('/curso') }}" class="nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FFF"
                    ...
                    <li class="nav-item me-2">
                        <a href="{{ url('/disciplina') }}" class="nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FFF"
                                ...
                                <path
                                    d="M6 8V1h1v6.117L8.743 5.27a.5.5 0 0 1 .757.429v5.602a.5.5 0 0 1-.757.429L7 9.883V15H6z" />
                                <path
                                    d="M2 1h10a1 1 0 0 1 1 1v13.5a.5.5 0 0 1-.5.5H2V1zM1 1v14H.5a.5.5 0 0 1-.5-.5V1.5A.5.5 0 0 1 .5 1H1z" />
                            </svg>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="" class="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#777"
